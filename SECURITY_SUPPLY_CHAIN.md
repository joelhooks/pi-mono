...
This repo treats dependency, workflow, package, script, and release changes as security-sensitive.
...
- Require review for workflows, package manifests, lockfiles, `.npmrc`, packages, scripts, and release config.
